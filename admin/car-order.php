...
<body >
    <div>
        <h1>Customer Order ADD/UPDATE/DELETE</h1>
    </div>
    ...
    <form action="car-order-pro.php" method="POST" class="container">
        ...
        <label for="shipping"><b>Shipped or Not?</b></label> <br>
            <input type="datetime-local" name="shipping"  value="<?php echo $shipping; ?>">
    ...
    <?php
       ...
       $result = $mysqli->query("SELECT * FROM car_order") or die($mysqli->error);
       //pre_r($result);
    ...
    <div>
        <h3 style="text-align: center;">Availabe Customer Orders</h3>
    </div>
            ...
            <?php 
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="car-order.php?edit=<?php echo $row['id']; ?>" class="edit">Edit</a><br>
                        <br>
                        <a href="car-order-pro.php?delete=<?php echo $row['id']; ?>" class="delete">Delete</a>
                    </td>
                </tr>
            <?php };?>
        </table>
