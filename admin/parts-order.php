...
<body >
    <div>
        <h1>Parts Order ADD/UPDATE/DELETE</h1>
    </div>
    ...
    <?php
       ...
       $result = $mysqli->query("SELECT * FROM parts_order") or die($mysqli->error);
       //pre_r($result);
    ...
    <div>
        <h3 style="text-align: center;">Availabe Orders</h3>
    </div>
            ...
            <?php 
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="parts-order.php?edit=<?php echo $row['id']; ?>" class="edit">Edit</a><br>
                        <br>
                        <a href="parts-order-pro.php?delete=<?php echo $row['id']; ?>" class="delete">Delete</a>
                    </td>
                </tr>
            <?php };?>
        </table>
