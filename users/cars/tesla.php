...
<body class="container-fluid">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="../../images/model3/1.jpg" class="d-block w-100" alt="...">
        </div>

        <div class="carousel-item">
            <img src="../../images/model3/2.jpg" class="d-block w-100" alt="...">
        </div>

        <div class="carousel-item">
            <img src="../../images/model3/3.jpg" class="d-block w-100" alt="...">
        </div>

        <div class="carousel-item">
            <img src="../../images/model3/4.jpg" class="d-block w-100" alt="...">
        </div>
    ...
    <!-- Tab links -->
        ...
        <div class="box-container">
            ...
            <div id="London" class="tabcontent">
                ...
                $result = $mysqli->query("SELECT * FROM car_basic WHERE id='5'") or die($mysqli->error);
            ...
            <div id="Paris" class="tabcontent">
                <?php
                    $mysqli = new mysqli('localhost', 'root', 'As+s01galaxysa', 'csmotors') 
                    or die(mysqli_error($mysqli));
                    $result = $mysqli->query("SELECT * FROM car_infor WHERE id='5'") or die($mysqli->error);
            ...
            <div id="Tokyo" class="tabcontent">
                <?php
                    $mysqli = new mysqli('localhost', 'root', 'As+s01galaxysa', 'csmotors') 
                    or die(mysqli_error($mysqli));
                    $result = $mysqli->query("SELECT * FROM car_review WHERE id='5'") or die($mysqli->error);
