...
<body >
    <div>
        <h1>Parts Details ADD/UPDATE/DELETE</h1>
    </div>
    ...
    <form action="parts-pro.php" method="POST" class="container">
        <input type="hidden" name="id" id="id" value="<?php echo $id; ?>">

        <div>
            <label for="name"><b>Parts Name</b></label> <br>
    ...
    <?php
       ...
       $result = $mysqli->query("SELECT * FROM parts") or die($mysqli->error);
       //pre_r($result);
